<template>
  <div id="printMe" class="user-info">
    <i
      v-print="'#printMe'"
      class="el-icon-printer printNb"
...
import { getPersonalDetail, updatePersonal, saveEmployee } from '@/api/employees'
export default {
  name: 'UserInfo',
  props: {
    id: {
  ...
  methods: {
    ...
    saveUser () {
      saveEmployee(this.id, this.userInfo)
    },
    savePersonal () {
      updatePersonal(this.formData)
    }
  }
}
</script>
